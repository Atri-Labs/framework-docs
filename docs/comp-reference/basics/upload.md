...
```
:::info
If you want to use the Image uploaded using the upload button use our [create_media_function](https://docs.atriutils.com/image-utils/create-media-response) for convenient processing/creating your backend.
:::info